        ...
        <form method="POST" action="<?php echo site_url("transaction/save") ?>" onsubmit="return valid_data()">
            ...
            <table id="vau_tab">
                ...
                <tbody id="add">
                    <tr class="mb-2">
                        <td>
                            <select id="acc_code_1" name="acc_code[]" class="form-control acc_code" style="width: 80%;" onchange="set_gr(1)" required>
                                <option value="">Select</option>
                                <?php
                                foreach ($row as $value) {
                                    echo "<option value=" . $value->sl_no . ">" . $value->ac_name . "</option>";
                ...
                <tr>
                    <td colspan="3" style="text-align:right;">
                        <strong>Total:</strong>
                        <input name="tot_amt" type="text" class="transparent_tag" id="tot_amt" style="text-align:left; color:#c1264d; font-size: 25px; width:16%;" readonly>
                    </td>
                </tr>
