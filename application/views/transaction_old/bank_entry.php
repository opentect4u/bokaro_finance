    ...
    <div class="col-md-9 container form-wraper">
        ...
        <form method="POST" action="<?php echo site_url("transaction/bank_save") ?>" onsubmit="return valid_data()">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select class="form-control select_2" name="voucher_type" id="v_type" onchange="set_dr_cr()" class="input_text" required>
                ...
                <div class="col-sm-3">
                    <select class="form-control select_2" name="transfer_type" id="t_type" onchange="set_dr_cr()" class="input_text" required>
                        <option value="">Select</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <select name="bank_cd" class="form-control select_2" style="display: inline;">
            ...
            <table id="vau_tab">
                ...
                <tr><td colspan="2"><td>
                    <td colspan="3" style="text-align:right;"><strong>Total:</strong> <input name="tot_amt" type="text" class="transparent_tag" id="tot_amt" style="text-align:left; color:#c1264d; font-size: 25px;" readonly>
                    </td>
                </tr>
            </table>
