                ...
                <tbody id="add">
                    ...
                    foreach ($ac_dtls as $dt) { ?>
                        <tr class="mb-2">
                            ...
                            <td><button type="button" class="delete" date="<?php echo $dt->acc_code; ?>" id="<?php echo $dt->acc_code; ?>?<?= $voucher_detail->voucher_id ?>" data-toggle="tooltip" data-placement="bottom" title="Delete">
