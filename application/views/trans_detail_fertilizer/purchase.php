...
<option value="">Select</option>
	...
	?>     
		...
		<input type="text" style="width:80px"  name="unit_name" class="form-control required" 
		value = "<?php echo $stock->unit_name; ?>"   readonly		/>
		<input type="hidden" style="width:80px"  name="unit_id" class="form-control required" 
		value = "<?php echo $stock->unit; ?>"   readonly		/>
</div>
<label for="storage" class="col-sm-1 col-form-label">Container:</label>
		...
		<input type="text" style="width:80px"  name="storage" class="form-control required" 
value = "<?php
 if($stock->storage=='B') {echo 'BAG';}elseif($stock->storage=='T') {echo 'Bottle';}
 ?>"   readonly		/>
	</div>
	<label for="qty_per_bag" class="col-sm-1 col-form-label">Qty Per Container:</label>

<div class="col-sm-1">

<input type="text" style="width:80px"  name="qty_per_bag" class="form-control required" 
value = "<?php echo $stock->QTY_PER_BAG; ?>"   readonly		/>
</div>
