<div class="wraper">
    ...
    <div class="col-md-8 container form-wraper">
        ...
        <form method="POST" action="<?php echo site_url("/handling-trandport-charges/customar-edit/".$editData[0]['id']);?> "
            onsubmit="return valid_data()">

            <div class="form-header">

                <h4>Edite handling & transport charges  Customer</h4>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" name="sac_code" class="form-control sac_code" value="<?php if(!empty($editData[0]['sac_code'])){ echo $editData[0]['sac_code'];} ?>" required>
                </div>
